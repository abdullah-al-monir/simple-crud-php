    ...
    <div class="max-w-3xl mx-auto bg-slate-100 rounded-lg p-5 shadow-lg my-10">
      <form method="POST" action="/notes/edit">
        ...
        <textarea class="w-full mt-1 p-2" name="description" id="" cols="30" rows="5"
          placeholder="Write the description here"><?= isset($_POST['description']) ? $_POST['description'] : $note['description'] ?>
</textarea>
        ...
        <?php endif; ?>
        <p class="text-right space-x-5">
          <a href="/notes"
            class=" py-2 px-4 bg-red-600 rounded-lg text-white font-semibold hover:bg-red-400 hover:text-black mt-5">
            Cancel
          </a>
          <button
