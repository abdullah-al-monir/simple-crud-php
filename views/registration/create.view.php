    ...
    <section class="">
      <div class=" items-center px-5 py-12 lg:px-20">
        <div
          ...
          <div class="mt-8">
            <h1 class="text-center font-bold text-2xl md:text-3xl lg:text-4xl tracking-wider">Register</h1>
            <div class="mt-8">
              <form action="/register" method="POST" class="space-y-6">
                ...
                <div>
                  <button type="submit"
                    class="flex items-center justify-center w-full px-10 py-4 text-base font-medium text-center text-white transition duration-500 ease-in-out transform bg-blue-600 rounded-xl hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Register</button>
                </div>
              </form>
            </div>
          </div>
